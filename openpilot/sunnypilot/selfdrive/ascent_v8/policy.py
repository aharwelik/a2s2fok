...
PANDA_LONG_RUNTIME_COMPILED = True
TRAFFIC_CONTROL_RUNTIME_COMPILED = True
TRAFFIC_CONTROL_EVIDENCE_RUNTIME_COMPILED = True
TRAFFIC_CONTROL_EVIDENCE_DEFAULT = False
AUTOMATIC_PASS_RUNTIME_COMPILED = False
LANE_CHANGE_EVIDENCE_RUNTIME_COMPILED = True
LANE_CHANGE_EVIDENCE_DEFAULT = False
